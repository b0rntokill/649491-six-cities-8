...
- Рефактор reducer. Разбиение его согласно задач - 09.02 - 10.02
- Подключение RTK. Рефакторинг проекта с его использованием - 10.02 - 12.02
- Избавляем проект от connect. Рефактор компонентов с использаванием соответсвующих хуков - 14.02 - 15.02
- Рефакторинг компонентов (разбиваем на удобно читаемые компоненты, SRP и тп) - 15.02 - 17.02
